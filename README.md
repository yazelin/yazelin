...
I build practical AI-powered software across industrial automation, agent tooling, voice interfaces, and small products that solve real workflow problems.

用 AI 開發軟體、用軟體取代昂貴感測器。我長期在工業自動化、AI agent、語音互動與實用工具之間找可落地的解法。

10+ years in industrial automation and system integration. Currently a software engineer at [ChingTech](https://www.ching-tech.com).
...
KUKA robots, ROS2 AGV fleets, AOI vision systems, and PLC integration.  
KUKA 機器人、ROS2 AGV 車隊、工業視覺 AOI、PLC 整合。

**AI Applications / AI 應用**  
Claude Code, Codex, MCP servers, LINE bots, and AI image generation.  
Claude Code、Codex、MCP Server、LINE Bot、AI 圖片生成。

**Product Software / 產品軟體**  
Tauri, Rust, Python, TypeScript, FastAPI, React, and Vue.  
Tauri、Rust、Python、TypeScript、FastAPI、React / Vue。

## Featured Projects

### [Mori Desktop](https://github.com/yazelin/mori-desktop)

A personal AI desktop companion built with Tauri 2, Rust, and React.  
森林精靈 Mori 的桌面身體，Tauri 2 + Rust + React 的個人 AI 管家。

### [ChingTech OS](https://github.com/yazelin/ching-tech-os)
...
- [codex-image-service](https://github.com/yazelin/codex-image-service)  
  ...
  個人 homelab FastAPI 圖片生成服務，包裝 Codex CLI image workflow。

- [codex-imagegen-skill](https://github.com/yazelin/codex-imagegen-skill)  
  Claude Code image-generation skill and standalone batch CLI.  
  Claude Code 圖片生成 skill 與批次 CLI 工具。

- [nanobanana-py](https://github.com/yazelin/nanobanana-py)  
  Gemini image-generation MCP server built with FastMCP.  
  Gemini 圖片生成 MCP Server，使用 FastMCP。

- [erpnext-mcp](https://github.com/yazelin/erpnext-mcp)  
  MCP server for ERPNext REST APIs.  
  ERPNext REST API MCP Server。

- [printer-mcp](https://github.com/yazelin/printer-mcp)  
